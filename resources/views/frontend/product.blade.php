					...
					<div class="p-l-25 p-r-30 p-lr-0-lg">
						<div class="wrap-slick3 flex-sb flex-w">
							...
							<div class="slick3 gallery-lb">
								...
								<div class="item-slick3" data-thumb="{{URL::to($image->sub_image)}}">
									<div class="wrap-pic-w pos-relative">
										<img src="{{URL::to($image->sub_image)}}" alt="IMG-PRODUCT">

										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="{{URL::to($image->sub_image)}}">
							...
							<div class="p-t-33">
								...
								<div class="flex-w flex-r-m p-b-10">
									...
									<div class="size-204 respon6-next">
										...
										<font color="red">{{ ($errors->has('size')) ? ($errors->first('size')) : '' }}</font>
									</div>
								</div>
