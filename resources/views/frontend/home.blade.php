					...
					<div class="wrap-filter flex-w w-full" style="background-color: #858585;">
				        <div>
				            ...
				            <div style="padding: 0px 20px 20px 20px;">
				                ...
				                <a href="{{ route('brand.product',$bra->brand->slug) }}" class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" href="" class="filter-link stext-106 trans-04" style="color: #fff">
				                    {{$bra->brand->name}}
				                </a>
				                @endforeach
				            </div>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							...
							<a href="{{ route('product.detail',$product->slug) }}" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04">
								Add to Card
							</a>
						</div>
