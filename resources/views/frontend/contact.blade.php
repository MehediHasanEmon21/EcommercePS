				...
				<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
					<form method="post" action="" id="form">
                        ...
                        <div class="bor8 m-b-20 how-pos4-parent">
                            ...
                            <img class="how-pos4 pointer-none" src="{{ asset('public/assets/frontend') }}/images/icons/user.png" alt="ICON">
                        ...
                        <div class="bor8 m-b-20 how-pos4-parent">
                            ...
                            <img class="how-pos4 pointer-none" src="{{ asset('public/assets/frontend') }}/images/icons/icon-email.png" alt="ICON">
                            <font color="red"><b></b></font>
                        </div>
                        ...
                        <div class="bor8 m-b-20 how-pos4-parent">
                            ...
                            <img class="how-pos4 pointer-none" src="{{ asset('public/assets/frontend') }}/images/icons/mobile.png" alt="ICON">
                            <font color="red"><b></b></font>
                        </div>
